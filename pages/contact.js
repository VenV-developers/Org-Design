  ...
  return (
    <Screen>
      <Head>
        ...
        <meta
          name="description"
          content="Contact Information of VenV (Hackathon & Coding Club), BIT Sindri, Dhanbad"
        />
        <meta
          name="keywords"
          content="HTML, CSS, JavaScript, ReactJS, NextJS, TailwindCSS, VenV, Contact VenV, Hackathon & Coding Club, BIT Sindri, Dhanbad"
        />
      </Head>
  ...
  return (
    ...
    >
      ...
      <p className="mt-20 w-3/5 text-lg xl:w-3/5 sm:w-3/4 sm:text-base">
        ...
        <span>
          <a className="text-blue" href="https://blog.VenVbits.com/">
            blog
          </a>
        </span>{' '}
        and roam around the{' '}
