...
const options = [
  ...
  },
  {
    ...
    body: (
      <>
        In college, VenV operates from IT Building, BIT Sindri, Dhanbad,
  ...
  },
  {
    ...
    body: (
      <>
        ...
        or follow{' '}
        <a href="https://learn.VenVbits.com" target="_blank" rel="noreferrer">
          VenV Learn.
        </a>
      </>
    ),
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <a
          href="https://blog.VenVbits.com/2020-07-16-LinuxExp-blog/"
          target="_blank"
          rel="noreferrer"
        >
          Developer Docs
    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li>
            <a
              href="https://contest.VenVbits.com"
              target="_blank"
              rel="noreferrer"
            >
              VenV Contest Page
          ...
          <li>
            <a
              href="https://hackatron19.VenVbits.com"
              target="_blank"
              rel="noreferrer"
            >
  ...
  },
  {
    ...
    body: (
      <>
        <a
          href="https://www.facebook.com/VenVbits/"
          target="_blank"
          rel="noreferrer"
        >
          Facebook
        ...
        <br />
        <a
          href="https://www.linkedin.com/company/VenVbits/"
          target="_blank"
          rel="noreferrer"
        >
          LinkedIn
        ...
        <br />
        <a
          href="https://www.instagram.com/VenVbits/"
          target="_blank"
          rel="noreferrer"
        >
          Instagram
        ...
        <br />
        <a href="https://github.com/VenVbits" target="_blank" rel="noreferrer">
          GitHub
        </a>
      </>
    ),
